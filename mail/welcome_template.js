...
<head>
    ...
    <title>Welcome to Code To Dev</title>
    <style>
        html,
        body {
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td style="padding: 30px 40px 30px 40px; text-align: center;"> <span
                                        style="color:#fff; font-size: 30px">Welcome to Code To Dev</span> </td>
                            </tr>
                        </table>
                    </td>
                </tr>
                <tr>
                    <td background="https://source.unsplash.com/random" bgcolor="#222222" align="center" valign="top"
                                        ...
                                        <table>
                                            ...
                                            <tr>
                                                <td valign="top"
                                                    ...
                                                    <p style="margin: 0;">Tap the button below to confirm your email
                                                        address. The system will vertify you to be able to use the
                                                        system.</p>
                                                </td>
                                            </tr>
                                            <tr>
                                                        ...
                                                        <table role="presentation" align="center" cellspacing="0"
                                                            ...
                                                            <tr>
                                                                <td style="border-radius: 50px; background: #26a4d3; text-align: center;"
                                                                    class="button-td"> <a href="${URL}/vertify/${token}"
                        ...
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            ...
                            <tr>
                                <td
                                    ...
                                    <p style="margin: 0;">For what reason would it be advisable for me to think about
                                        business content? That might be little bit risky to have crew member like them.
                                        For what reason would it be advisable for me to think about business
                                        content?<br><br> That might be little bit risky to have crew member like them.
                                        For what reason would it be advisable for me to think about business content?
                                        That might be little bit risky to have crew member like them.</p>
                                </td>
                            </tr>
                        </table>
                    </td>
                                    ...
                                    <table role="presentation" align="center" cellspacing="0" cellpadding="0" border="0"
                                        ...
                                        <tr>
                                            <td style="border-radius: 50px; background: #ffffff; text-align: center;"
                                                class="button-td"> <a href="http://www.google.com"
                ...
                <tr>
                    <td bgcolor="#ffffff">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%"> <br>
                            <tr>
                                <td align="center"> <img src="https://img.icons8.com/dusk/64/000000/ms-share-point.png"
                            ...
                            <tr>
                                <td
                                    ...
                                    <p style="margin: 0;">This email was sent to you from lomonlao@gamil.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td
                                    ...
                                    <p style="margin: 0;">Copyright &copy; 2020-2021 <b>www.codetodev.com</b>, All Rights
                                        Reserved.</p>
                                </td>
                            </tr>
                        </table>
